import FavoriteIcon from "@mui/icons-material/Favorite";import dayjs from "dayjs";
	...
	return (
		<li className="flex justify-between gap-x-6 py-5">
			...
			<div className="flex flex-col items-end">
				...
				<p className="mt-1 text-xs leading-5 text-gray-400 font-bold">Added {timeAgo}</p>
			</div>
		</li>
	);
}
