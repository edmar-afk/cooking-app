...
const tips = [
	{
		...
		description: "Choose heart-healthy oils like olive, avocado, or canola oil instead of butter or lard.",
	},
		...
		<>
			<div className="mt-8">
				...
				<div className="flex flex-row mt-4 gap-4">
					<p className="mt-2">Healthy eating isn’t about depriving yourself of foods you love</p>
					<div className="text-white p-5 rounded-md relative overflow-hidden bg-orange-500">
						<svg
					...
					{tips.slice(1).map((tip, index) => (
						<div
							...
							<img
								...
								alt=""
							/>
							<p className="text-center font-semibold text-xs mt-2">{tip.title}</p>
						</div>
					))}
				</div>
			</div>
